...
public class BurpeeV2 : SportsExerciseBase
{
    protected override SportType SportType => SportType.BurpeeV2;
    protected override string PathGif => "Files/BurpeeV2_gif.mp4";

    public BurpeeV2(UnitOfWork unitOfWork, NotificationService notificationController) : base(unitOfWork, notificationController)
    {
    }
