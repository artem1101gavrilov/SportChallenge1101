...
{
    protected override SportType SportType => SportType.LegSwings;
    protected override string PathGif => "Files/LegSwings_gif.mp4";

    public LegSwings(UnitOfWork unitOfWork, NotificationService notificationController) : base(unitOfWork, notificationController)
    {
    }
